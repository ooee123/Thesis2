...
public class PDGNodeSwitch extends PDGNodeContainsStatementNode<SelectionStatementIf> {
    @NonNull private PDGNode<? extends Statement> thenNode;
    private PDGNode<? extends Statement> elseNode;

    public PDGNodeSwitch(SelectionStatementIf selectionStatementIf, PDGNode<? extends Statement> thenNode, PDGNode<? extends Statement> elseNode) {
        this(selectionStatementIf, thenNode, elseNode, false);
    }

    public PDGNodeSwitch(SelectionStatementIf selectionStatementIf, PDGNode<? extends Statement> thenNode, PDGNode<? extends Statement> elseNode, boolean required) {
